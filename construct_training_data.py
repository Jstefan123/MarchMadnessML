...
reg_season_df = pd.read_csv('filtered_data/17-18/reg_season_results.csv')
tourney_df = pd.read_csv('filtered_data/17-18/ncaa_tourney_results.csv')


team_vectors = {}
with open('filtered_data/17-18/team_vectors.json') as infile:
